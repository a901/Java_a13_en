...
public class a13 extends JFrame   implements Serializable{ //視窗渲染工具庫 
...
void pamap2()
{
	...
	for(int i=0;i<24;i++)
	{
		x0=a13.a1.borderx1+(i-1)*lx;
		for(int j=0;j<20;j++)
		{
			y0=a13.a1.bordery1+(j-1)*ly;
			gg=0;
			gh=0;
			...
			gn=0;
			h=0;hn=0;k=0;
			for(int zx=x0;zx<x0+lx;zx++)
			{
				for(int zy=y0;zy<y0+ly;zy++)
				{
...
//	System.out.print("pa\n");
	...
	for(int z=1;z<a13.a1.bn;z++)//*********************   繪雙方格圖框
	{
		if(a13.a1.b[z]!=null && a13.a1.b[z].s<0)
			continue;
