...
public class B  implements Serializable{  //人物類別(活人)，計算活人的行為
	...
	int work=0,workx,worky,weapon=0;
	int hero=0;
	...
	void addB(int faa,int maa,int faa0,int maa0,int w,int s)
	{
	    ...
	    this.k0=a13.a1.allbn;
	 //  System.out.print(" addB  k0="+k0+" a13.a1.allbn="+a13.a1.allbn);
		...
		this.fertility=(int)(Math.random()*12121)%3+1;
	...
	void findfood(int gx,int gy,int kk)
	{
		...
		{			
			...
			int gg=0;
			for(int i=cx[cn]-3;i<cx[cn]+4;i++)
			{
				for(int j=cy[cn]-3;j<cy[cn]+4;j++)
				{
			...
			if(sex==1&&age()>13&&age()<60)
			{
				if((int)(Math.random()*12191)%7<=gg&&(int)(Math.random()*12191)%3!=1&&hungry<40)
				{
					cn=0;
					return;
				}
				...
				if((int)(Math.random()*12191)%4<=gg&&(int)(Math.random()*12191)%6!=1&&hungry<50)
				{
					cn=0;
					return;
				}
		...
		if(a13.n1.an>=goalan)
		{
			...
			if(find!=201||hungry<40||(int)(Math.random()*92191)%3>0||a13.a1.year-borntime<13)
			{
				cn=0;
				return;
			}	
		...
		else if((int)(Math.random()*7377)%3==1)
		{ 
			 subfindfood( gx, gy+1,kk);
			 subfindfood( gx-1, gy,kk);
			 subfindfood( gx, gy-1,kk);
		...
		else if((int)(Math.random()*7777)%2==1)
		{
			 subfindfood( gx, gy-1,kk);
			 subfindfood( gx-1, gy,kk);
			 subfindfood( gx+1, gy,kk);
	...
	void subfindfood(int gx,int gy,int p) {
		...
		if(a13.a1.map[gx][gy]!=-1) {
			if(a13.a1.map[gx][gy]==find||(find==1&&a13.a1.map[gx][gy]>=1000))
			{
	...
	void boring()
	{
		...
		if(a13.a1.year-this.borntime<13) {
			...
			if(a13.a1.b[ma].k0==ma0&&a13.a1.b[ma].group==group&&(int)(Math.random()*12781)%3!=1) {
				find=ma+1000;
				if(age()<=5)
					goalan=180;
				else if(age()<=10)
	...
	if(age()<=14)
		...
		for(int z=0;z<fn;z++) {
			...
			if(a13.a1.b[gh].group==group)
				 gru1=50;
			else
				gru1=0;
			
			if(gg>=0&&a13.a1.b[f[gg]].group==group)
				 gru2=50;
			else gru2=0;
		
			if(gg==-1||ff[z][2]+gru1+a13.a1.b[gh].borntime>ff[gg][2]+gru2+a13.a1.b[f[gg]].borntime)
				gg=z;
		}
		if(gg==-1)
			return gg;
	...
	void meetone2(int gg,int r)//************** 左右遇人
	{
		...
		if(a13.a1.b[gg].rob>0&&age()>=13&&rob==0&&ff[gh][2]<=85&&(strong>=a13.a1.b[gh].strong||((int)(Math.random()*17121)%3==1)))
		{
			
			
			if(group>=0&&a13.a1.b[gg].tie<=0&&((sex==1&&(int)(Math.random()*17121)%14==1)||(sex==2&&(int)(Math.random()*12721)%19==1)))
			{
				...
				if(a13.a1.b[gg].sin>=100) {
					...
					if((int)(Math.random()*13123)%3==1)
					{
						a13.a1.b[gg].tie=70+a13.a1.b[gg].sin/2;						
					}
					else {
				...
				a13.a1.b[gg].rob=a13.a1.b[gg].tie;
			...
			else if((group<0)&&((sex==1&&(int)(Math.random()*17121)%14==1)||(sex==2&&(int)(Math.random()*12721)%31==1))){
		...
		if(rob>8&&tie<=0&&((sex==1&&(int)(Math.random()*12121)%31==1)||(sex==2&&(int)(Math.random()*1221)%41==1))&&(strong>=a13.a1.b[gg].strong||(int)(Math.random()*11771)%3==1)&&(ff[gh][2]<=25&&a13.a1.b[gg].fa0!=k0&&a13.a1.b[gg].ma0!=k0))
		{
		...
		//攻擊外族 attack other tribes' members ( at wars )
		int gk=(int)(Math.random()*12121)%4;
		if(a13.a1.b[gg].group!=group&&(strong+(2-sex)*5+gk-1>=a13.a1.b[gg].strong+(2-a13.a1.b[gg].sex)*5)&&a13.a1.b[gg].group>=0&&group>=0&&a13.a1.group[group].level==1&&weapon>0&&person%31<26&&a13.a1.b[gg].bekill==0&&weapon>0&&(a13.a1.b[gg].weapon>0||person%31<7))//(sex==1||person%31<7)&&age()>13
		{
			if(((x-a13.a1.group[group].x)*(x-a13.a1.group[group].x)+(y-a13.a1.group[group].y)*(y-a13.a1.group[group].y)<25*25)||(a13.a1.group[group].relation[a13.a1.b[gg].group]<=0&&(int)(Math.random()*11111)%4==1)||a13.a1.group[group].relation[a13.a1.b[gg].group]<=-30) {
	...
	void work()
	{
		if(job>0||group<0||a13.a1.group[group].level>1||a13.a1.group[group].leader<0)
			return;
		if(cn>0||age()<12||work>0||transfer>0||pain>0)
			return ;
		
	
		if((int)(Math.random()*12121)%19==7&&(sex==1||person%17<4)&&weapon==0)
		{
			g=0;
			workx=x;worky=y;
		...
		else if((int)(Math.random()*12171)%5==1)
		{
		...
		if((int)(Math.random()*12171)%2==1)
		{	
			find=0;
			int g1,g2,g3,g4;
			g1=count_pop(x-15,y,8);
			g2=count_pop(x+15,y,8);
			g3=count_pop(x,y-15,8);
			g4=count_pop(x,y+15,8);
			g=count_pop(x,y,8);
			if(g1<g-2&&g1<=g2&&g1<=g3&&g1<=g4) {
					
				setgoplace(x-12,y,2);
				return;
			}
			else if(g2<g-2&&g2<=g1&&g2<=g3&&g2<=g4) {
				
				setgoplace(x+12,y,2);
				return;
			}
			else if(g3<g-2&&g3<=g1&&g3<=g2&&g3<=g4) {
				setgoplace(x,y-12,2);
				return;
			}
			else if(g4<g-2&&g4<=g1&&g4<=g2&&g4<=g3){
		...
		if((int)(Math.random()*12171)%7==1)
		{	
			find=0;
			goalx=a13.a1.group[group].placex;
			goaly=a13.a1.group[group].placey;
			
			if((goalx-x)*(goalx-x)+(goaly-y)*(goaly-y)>30*30)
			{
				if((goalx-x)>0)g=1;else g=-1;
				if((goaly-y)>0)gg=1;else gg=-1;
				
				setgoplace(goalx,goaly,5);
				return;
			}
	...
	//	System.out.print("b "+k+"  "+k0+" "+s+"\n");
		...
		if(godie1>0)
			...
			a13.a1.map[x][y]=154;//1000000000+k0;
		else
		a13.a1.map[x][y]=151;//1000000000+k0;
		
		if(tie>0) {
			//a13.a1.allb[k0].diereason+="(executed)";
			//a13.a1.violencedie++;
		}
	...
	void subcreategroup0(int h,int hh) {//族群眾人傳播該族群標籤
		//System.out.println("sub recount "+k+" "+l);
	//	System.out.println("sub recount "+k0+" "+name);		
		if(group!=-1&&group!=h&&group!=hh)
			return;
		
		if(group!=h&&hh>=0&&a13.a1.group[h].gnumber>a13.a1.group[hh].gnumber/2)
			return;
			//if(gsub==1)return;
		gsub=1;
				...
				if(a13.a1.map[i][j]>1000) {
					...
					if(a13.a1.b[g].gsub!=1) {
						...
						if(hh>=-1) {	
							...
							a13.a1.b[g].subcreategroup0(h,hh);
					}
				}
			}
		}
	...
	void create() //  特殊事件發生
	{
		...
		if(sex==2&&age()>=13)
		{
			...
			for(int i=x-11;i<x+11;i++)
			{
				for(int j=y-11;j<y+11;j++)
				{
					...
					if(a13.a1.b[g].group>-1&&a13.a1.b[g].group!=group&&a13.a1.b[g].age()>13) {
						nn++;gh=a13.a1.b[g].group;}
					else if(a13.a1.b[g].sex==1&&age()>13&&a13.a1.b[g].group==group)
						nn-=100;
				}
			}
			if(nn>7)
		...
		if(age()<13)
		{
			if(a13.a1.allb[k0].group1<0)
				a13.a1.allb[k0].group1=group;
		}
		...
		if((int)(Math.random()*12121)%101<=3&&wise>=103&&group>=0&&a13.a1.group[group].leader>-1&&a13.a1.group[group].gnumber>120+a13.a1.group[group].rand%100&&person%17>3) {// 分裂族群
			
			
			for(int z=0;z<a13.a1.groupn;z++)
			{
				g=(a13.a1.group[z].x-x)*(a13.a1.group[z].x-x)+(a13.a1.group[z].y-y)*(a13.a1.group[z].y-y);
				if(g<18*18*2)
					return;
			}
			...
			int px=a13.a1.group[group].x;
			int py=a13.a1.group[group].y;
			
			for(int z=0;z<a13.a1.bn;z++)
			{
				if(a13.a1.b[z].group!=group)
					continue;
				gg=(a13.a1.b[z].x-px)*(a13.a1.b[z].x-px)+(a13.a1.b[z].y-py)*(a13.a1.b[z].y-py);
				g=(a13.a1.b[z].x-x)*(a13.a1.b[z].x-x)+(a13.a1.b[z].y-y)*(a13.a1.b[z].y-y);
				if(gg<g)n1++;
				else n2++;
			...
			if(a13.a1.group[gh].sonn<98) {
				
				a13.a1.group[gh].son[a13.a1.group[gh].sonn]=a13.a1.groupn;
				a13.a1.group[gh].sonn++;
			}
			...
			a13.n1.maincreategroup(a13.a1.groupn,gh,k);
			
			for(int z=0;z<a13.a1.bn;z++)
			{
				if(a13.a1.b[z].group!=gh)
					continue;
				gg=(a13.a1.b[z].x-px)*(a13.a1.b[z].x-px)+(a13.a1.b[z].y-py)*(a13.a1.b[z].y-py);
				g=(a13.a1.b[z].x-x)*(a13.a1.b[z].x-x)+(a13.a1.b[z].y-y)*(a13.a1.b[z].y-y);
				if(gg<g)n1++;
				...
				{
					a13.a1.b[z].group=a13.a1.groupn;				
				}					
			}
		...
		if((int)(Math.random()*12121)%17==1&&wise>=103&&group==-1&&person%17>4&&person%23>2&&age()>=30) {// 創建族群
	...
	int count_pop(int x,int y,int l)
	{
		int g=0,gg=0;
		for(int i=x-l;i<=x+l;i++)
		{
			...
			{
				g=a13.a1.map[i][j];
				if(a13.a1.mapall[i][j]/10==4||a13.a1.mapall[i][j]/10==3)
					gg+=10;
				if(a13.a1.mapall[i][j]%10>=4)
					gg+=1;
	...
	void creategroup() {// 創建族群	
		...
		a13.n1.maincreategroup(a13.a1.groupn,-1,k);
		for(int i=0;i<a13.a1.an;i++)
			a13.a1.b[a13.n1.ap[i]].gsub=0;
	...
	void looking() {
		if(a13.a1.year-borntime==0)
			mapa=1000;
				...
				mapa=102;
			else if(sex==1&&a13.a1.year-borntime>12)
				mapa=1010;
			else  if(sex==2&&a13.a1.year-borntime>12)
				mapa=1020;
			else if(sex==1)
				mapa=103;
			else if(sex==2)
	...
	void r()
	{
		gsub=0;
		if(k==0) {
			a13.a1.allb[k0].diereason+="暴斃(sudden death)";
			die();return;
		}
	
		//if(finaltime>0)System.out.print("b "+k+" "+name()+" move to x="+finalgoalx+" y="+finalgoalx+" t="+finaltime+"\n");
		
		
		hungry++;
		if(serioussick==1&&(int)(Math.random()*19991)%3!=1)
		{
			a13.a1.allb[k0].diereason="病故(sick)";
			die();
			return;
		}
		...
		if(sick>=1) {
			...
			{
				if(((int)(Math.random()*19991)+a13.a1.dayr*k)%9==1)//7*6
					serioussick=4;
				
			}
			else if(a13.a1.year-borntime>=50)
			{
				if(((int)(Math.random()*19991)+a13.a1.dayr*k)%15==7)//7*6
					serioussick=4;	
			}	
			else 
			{
				if(((int)(Math.random()*19991)+a13.a1.dayr*k)%37==7)//7*8
					serioussick=3;
			}
		}
		
			
		if(((int)(Math.random()*17777)+a13.a1.dayr+k0)%131==7||(age()>65&&(int)(Math.random()*17777)%61==7))//    1/(1/123*1/51*7*2/3)/30
		{
	...
	//	System.out.print("hungry="+hungry+" \n");
		...
		if(hungry>=85||(hungry>=75&&(age()>60||age()<11)))
		{
			if((int)(Math.random()*17771)%17==1) {
				a13.a1.allb[k0].diereason="餓死(starve)";
				a13.a1.starvedie++;
				die()	;
				return;
			}
			if(hungry>=115||(hungry>=105&&(age()>60||age()<11)))
			{
		...
		if(stop>0)
		{
			...
			if(bekill==1)
			{
				...
				a13.a1.allb[k0].diereason="被殺(killed)";
				a13.a1.violencedie++;
				die();
				return;
			}
		...
		if(tie>0)
		{
			...
			if(godie1==1)
			{
				a13.a1.allb[k0].diereason="絞刑(hanged)";
				a13.a1.violencedie++;
				die();
				return;
			}
		...
		if(a13.a1.mapall[x][y]/10==4) {
			//	System.out.print("b "+k+"swim "+swim+" "+x+" "+y+"   "+a13.a1.mapall[x][y]+"\n");
				if(swim<0)
				{
					if(swim==-1)
					{
						a13.a1.allb[k0].diereason="溺死(drown)";
						die();
						return;
					}
					swim++;
		...
		if(age()>13&&rob<5&&sick<=0&&((sex==1&&(int)(Math.random()*12121)%13==2)||(sex==2&&(int)(Math.random()*12121)%19==2)))					
		{
					
			if(hungry>65&&person%31<14)
				rob+=(hungry-45)+15;
			if(hungry>20&&person%31<5)
				rob+=(hungry-20)+25;
			if(person%31==0)
				rob+=10+(int)(Math.random()*12121)%15;
		...
		if(hungry>=0) {
			...
			{
				find=0;ex=x+1;ey=y;hungry-=70;cdelay=0;eat();return;
			}
			else if((a13.a1.map[x-1][y]==201||a13.a1.map[x-1][y]==211)&&testhight_2(x,y,x-1,y)>0)
			{
				find=0;ex=x-1;ey=y;cn=0;hungry-=70;cdelay=0;eat();return;
			}
			else if((a13.a1.map[x][y+1]==201||a13.a1.map[x][y+1]==211)&&testhight_2(x,y,x,y+1)>0)
			{
				find=0;ex=x;ey=y+1;cn=0;hungry-=70;cdelay=0;eat();return;
			}
			else if((a13.a1.map[x][y-1]==201||a13.a1.map[x][y-1]==211)&&testhight_2(x,y,x,y-1)>0)
			{
				find=0;ex=x;ey=y-1;cn=0;hungry-=70;cdelay=0;eat();return;
			}
			else if(a13.a1.year-borntime<4&&a13.a1.map[x][y-1]==ma+1000&&testhight_2(x,y,x,y-1)>0)
			{
				find=0;ex=x;ey=y-1;cn=0;hungry-=70;cdelay=0;eat();return;
			}
		}
		...
		if(cn==0) {
			...
			else if((int)(Math.random()*11111)%13==1)
			{
				work();
				return;
			}
	...
	void showfbl() {//**********************    顯示朋友親屬資料 (於右方介面全)  依熟系度排序***************
		...
		a13.setbl(7,720,150,600,30,1,"IQ:"+wise+" Strength:"+strong+"   k="+k+" k0="+k0+" cdelay="+cdelay+" ex="+ex+" ey="+ey+" state="+state);//+" job="+job+" k:"+k+" cn:"+cn+" home:"+home
		if(home>0)
		a13.setbl(6,720,180,400,30,1,"住處:"+a13.a1.b[a13.a1.f[home].host].name()+"' home");
		else if(finaltime>0)
			a13.setbl(6,720,180,400,30,1,"move to : x="+finalgoalx+" y="+finalgoaly+" t="+finaltime);
		...
		for(int x=0;x<9;x++) {
			...
			a13.setbl(31+x,720,230+x*30,400,30,1,a13.a1.allb[kk].name+a13.a1.allb[kk].midname+" "+a13.a1.allb[kk].generation+"th   "+y2+" "+yy+" Age:"+a13.a1.allb[kk].age+"  relationship:"+ff[gh][2]);
		}
