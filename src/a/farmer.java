...
public class farmer implements Serializable {
	...
	void stert_addmember(int k)
	{
		member0=0;
		int k0=a13.a1.b[k].k0;int hair=0;
		for(int z=0;z<a13.a1.allb[k0].kidn;z++)
		{
			g=a13.a1.allb[k0].kid[z];
			if(a13.a1.allb[g].s>0&&(hair==0||a13.a1.allb[g].age()<20))
			{
				member[member0]=g;
				member0++;
				hair=1;
