...
public class C implements Serializable{ //人物類別(活人+死人)，調看人物的資訊
	
	
	
	private static final long serialVersionUID = 177;
	int k0,fa0=-1,ma0=-1, generation,age,s,bk,borntime,sex;
	int kid[],love[]=new int [20],loveday[]=new int [20],loven=0,kidn=0,name0=0,wise=100,strong=100;
	...
	void showfbl2() {//**********************    顯示朋友親屬資料 (於右方介面全)  依熟系度排序***************
		...
		for(int x=0;x<9;x++) {
			...
			a13.setbl(8,720,100,450,30,1,name()+"'s family  ");
		String gender[]= {" ","male","female"};
		if(s<0)
		a13.setbl(6,720,140,450,30,1,"bron:"+borntime+" died at "+age+" y/o reason:"+diereason+" sin:"+sin);
		else
			a13.setbl(6,720,140,450,30,1,"Born in Year "+borntime+"    Age:"+age()+""+"   sin:"+a13.a1.b[bk].sin+" tie"+a13.a1.b[bk].tie);
		
		if(group1>=0&&group2>=0)
		a13.setbl(5,720,170,450,30,1,"tribe:"+a13.a1.group[group2].name+"    original tribe:"+a13.a1.group[group1].name);
		else if(group2>=0) a13.setbl(5,720,170,450,30,1,"tribe:"+a13.a1.group[group2].name);
		...
		if(a13.a1.b[g2].k0==fa0&&a13.a1.allb[fa0].s>0)
			a13.setbl(22,720,200,450,30,1,"Father:  "+a13.a1.allb[fa0].name()+"   Age: "+(a13.a1.year-a13.a1.b[g2].borntime)+" ");
		else
		...
		if(a13.a1.b[g2].k0==ma0&&a13.a1.allb[ma0].s>0)
			a13.setbl(23,720,230,450,30,1,"Mother:  "+a13.a1.allb[ma0].name()+"   Age: "+(a13.a1.year-a13.a1.allb[ma0].borntime)+" ");
		else
		...
		if(a13.a1.allb[fa0].fa0>=0) {
			...
			if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
				a13.setbl(24,720,260,450,30,1,"Grandpa:  "+a13.a1.allb[g].name()+"    Age: "+(a13.a1.year-a13.a1.b[g2].borntime)+" ");
			else
				a13.setbl(24,720,260,450,30,1,"Grandpa:  "+a13.a1.allb[g].name()+"     died at "+(a13.a1.allb[g].age)+" y/o");	
		}
		}
		if(fa0>=0) {
		if(a13.a1.allb[fa0].ma0>=0) {
			...
			if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
				a13.setbl(25,720,290,450,30,1,"Grandma:  "+a13.a1.allb[g].name()+"   Age: "+(a13.a1.year-a13.a1.b[g2].borntime)+" ");
			else	a13.setbl(25,720,290,450,30,1,"Grandma:  "+a13.a1.allb[g].name()+"     died at "+(a13.a1.allb[g].age)+" y/o");	
		}
		if(a13.a1.allb[ma0].fa0>=0) {
			g=a13.a1.allb[ma0].fa0;g2=a13.a1.allb[g].bk;
			if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
				a13.setbl(26,720,320,450,30,1,"Grandpa:  "+a13.a1.allb[g].name()+"    Age: "+(a13.a1.year-a13.a1.b[g2].borntime)+" ");
			else	a13.setbl(26,720,320,450,30,1,"Grandpa:  "+a13.a1.allb[g].name()+"     died at "+(a13.a1.allb[g].age)+" y/o");	
		}
		if(a13.a1.allb[ma0].ma0>=0) {
			g=a13.a1.allb[ma0].ma0;g2=a13.a1.allb[g].bk;
			if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
				a13.setbl(27,720,350,450,30,1,"Grandma:  "+a13.a1.allb[g].name()+"    Age: "+(a13.a1.year-a13.a1.b[g2].borntime)+" ");
			else	a13.setbl(27,720,350,450,30,1,"Grandma:  "+a13.a1.allb[g].name()+"     died at "+(a13.a1.allb[g].age)+" y/o");	
		}
		}
		...
		a13.setbl(21,720,420,450,30,1,"Number of children: "+kidn+"  Surviving children: "+g+"");
		a13.n1.pn=0;
		...
		if(g>=0)
		{
			...
			findoldkid3(k0);
			kp--;kd--;
			a13.setbl(8,720,490,400,30,1,"Total descendants:"+kd+"  Living descendants:"+kp+"");
		}
		else
			a13.setbl(29,720,480,400,30,1,"No descendants");
			
		a13.setbl(9,720,520,300,30,1,"E: return, Left/Right keys: Change page");
	...
	void showfbl21(int h) {//********************** *************** 情人
		...
		for(int x=h;x<h+10;x++) {
			...
			if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
	 		a13.setbl(31+x-h,720,(x-h)*40+80,450,30,1,a13.a1.allb[g].name()+"  Age(年紀):" +(a13.a1.year-a13.a1.b[g2].borntime)+"  "+flname(g)+" start at "+name+" "+loveday[x]+" y/o");	
			else 
				a13.setbl(31+x-h,720,(x-h)*40+80,450,30,1,a13.a1.allb[g].name() +" died  at "+(a13.a1.allb[g].age)+"  "+flname(g)+" start at "+name+" "+loveday[x]+" y/o");	
	...
	for(int x=h;x<h+10;x++) {
		...
		if(a13.a1.allb[g].k0==a13.a1.b[g2].k0&&a13.a1.allb[g].s>0)
 		a13.setbl(31+x-h,720,(x-h)*40+80,450,30,1,a13.a1.allb[g].name()+" " +(a13.a1.year-a13.a1.b[g2].borntime)+" y/o   "+flname(g)+" married at"+wifeday[x]+" y/o");	
		else 
			a13.setbl(31+x-h,720,(x-h)*40+80,450,30,1,a13.a1.allb[g].name() +" dead at "+(a13.a1.allb[g].age)+" (y/o)   "+flname(g)+" married at"+wifeday[x]+" y/o");	
...
void showfbl22(int k) {//********************** ***************
		...
		a13.cleanallb(); 
		String yy="";
		a13.setbl(1,720,40,450,30,1,name()+"'s patrilineal ancestors(父系祖先):");
		...
		for(int x=0;x<10;x++) {
			...
			if(a13.a1.allb[g].s<0)
	 		a13.setbl(31+x,720,480-x*40,450,30,1,a13.a1.allb[g].name()+"  born at "+a13.a1.allb[g].borntime+"  dead at "+a13.a1.allb[g].age()+" y/o");	
			else 
		 		a13.setbl(31+x,720,480-x*40,450,30,1,a13.a1.allb[g].name()+"  born at "+a13.a1.allb[g].borntime+"  currently "+a13.a1.allb[g].age()+" y/o");	
			
			g=a13.a1.allb[g].fa0;
			
		}
		a13.setbl(9,720,520,300,30,1,"E: return ,上下左右鍵換頁   ");
		a13.seta(11,700,0, 500,580,"talk4");
	}
 void showfbl23(int k) {//********************** ***************
		...
		a13.cleanallb(); 	
		String yy="";
		a13.setbl(1,720,40,450,30,1,name()+"'s matrilineal ancestor(母系祖先):");
		 int g=k0;
		for(int z=0;z<k;z++)
		{
			g=a13.a1.allb[g].ma0;
		...
		for(int x=0;x<10;x++) {
			...
			if(a13.a1.allb[g].s<0)
		 		a13.setbl(31+x,720,480-x*40,450,30,1,a13.a1.allb[g].name()+"   born at "+a13.a1.allb[g].borntime+"  died at "+a13.a1.allb[g].age()+" y/o");	
				else 
			 		a13.setbl(31+x,720,480-x*40,450,30,1,a13.a1.allb[g].name()+"   born at "+a13.a1.allb[g].borntime+"  currently "+a13.a1.allb[g].age()+" y/o");	
				g=a13.a1.allb[g].ma0;
			if(g<0)
...
void showfbl24(int h) {//********************** *************** 子輩
		...
		a13.cleanallb(); 	
		String yy="";int g=k0,g2;
		a13.setbl(1,720,40,450,30,1,name()+" 's childern(子輩) :");
...
void showfbl25(int h) {//********************** *************** 當前繼承人譜系
	...
	a13.setbl(1,720,40,450,30,1,thename()+"'s current hairs(當前繼承人)");	
	if(g==-1) {
		a13.setbl(2,720,100,450,30,1,"no living descendants(無存活後代)");
...
void showfbl26(int h,int cl) {//********************** *************** 歷任繼承人列表
	...
	findoldkidcl(k0);
	if(cl==0)
	a13.setbl(1,720,40,450,30,1,thename()+"'s  list of hairs(歷任繼承人):");	
	...
	a13.setbl(8,720,490,400,30,1,"total descendants:"+kd+"  descendants(living):"+kp+"");
		...
		a13.setbl(8,720,490,450,30,1,"Patrilineal descendants: "+kd+"  (living):"+kp+"");
	else if(cl==2)
		a13.setbl(8,720,490,450,30,1,"Matrilineal descendants:"+kd+"  (living):"+kp+"");
	a13.setbl(9,720,520,300,30,1,"E: retrun  Left,Right keys: change page");
	a13.seta(11,700,0, 500,580,"talk4");	
}
		 ...
		 //y2+=" ";
	    	...
	    	if(gh>=1&&m1[0]==m2[0]) {
	    		...
	    		if(borntime>=a13.a1.allb[kk].borntime)
	    			y2+=cu[a13.a1.allb[kk].sex];//y0[6+a13.a1.allb[kk].sex];
	    		if(borntime<=a13.a1.allb[kk].borntime)
	    			y2+=cu[2+a13.a1.allb[kk].sex];//;y0[8+a13.a1.allb[kk].sex];
