...
class key extends KeyAdapter{
	...
	int q=0,g,k,gg,k2,gh,g2,Z,ly=0,stop=0,screen=0,G=0,Gmap[][],page,wdelay=0,v0=0;//q=22+
...
//		System.out.println("你按了《up》鍵");
	...
	void key_x()
	{
		...
		if(q==6)
		{
			if(ly==0&&a13.a1.allb[k].fa0>=0)gh=a13.a1.allb[k].fa0;
			else if(ly==1&&a13.a1.allb[k].ma0>=0)gh=a13.a1.allb[k].ma0;
			else if(ly==2&&a13.a1.allb[k].fa0>=0&&a13.a1.allb[a13.a1.allb[k].fa0].fa0>=0)gh=a13.a1.allb[a13.a1.allb[k].fa0].fa0;
			else if(ly==3&&a13.a1.allb[k].fa0>=0&&a13.a1.allb[a13.a1.allb[k].fa0].ma0>=0)gh=a13.a1.allb[a13.a1.allb[k].fa0].ma0;
			else if(ly==4&&a13.a1.allb[k].ma0>=0&&a13.a1.allb[a13.a1.allb[k].ma0].fa0>=0)gh=a13.a1.allb[a13.a1.allb[k].ma0].fa0;
			else if(ly==5&&a13.a1.allb[k].ma0>=0&&a13.a1.allb[a13.a1.allb[k].ma0].ma0>=0)gh=a13.a1.allb[a13.a1.allb[k].ma0].ma0;
			else
				return;
			if(a13.a1.b[gh].k0==g&&a13.a1.b[gh].s>0)
			{
		...
		if(a13.screensize==4)
		{
			int lx=(a13.a1.borderx2-a13.a1.borderx1+48)/24;
			int ly=(a13.a1.bordery2-a13.a1.bordery1+40)/20;
			a13.screensize=0;
			a13.a1.mapx=a13.a1.borderx1+(a13.dx-1)*lx;
			a13.a1.mapy=a13.a1.bordery1+(a13.dy-1)*ly;
			a13.dx=5;
			a13.dy=5;
			return;
		}
	...
	public void keyPressed(KeyEvent e){
		...
		else if(a13.dy>19&&a13.screensize>=3)
		{
			a13.dy=19;
		}
		if(a13.a1.mapx<=200)
	...
	//	a13.setbl(3, 720,130, 350, 30, 1, "歷史累積部落數:"+a13.a1.groupn);
		...
		int g=0;
		double g3=0,g4=0;double g5,g6=0;
		if(a13.a1.yn>page+10) {
			for(int i=page+1;i<page+11;i++)
			{
				...
				g6+=a13.a1.populationviolence[i];
			...
			g6 = Double.parseDouble(df.format(g6));
			a13.setbl(2, 720,110, 550, 30, 1, "pop(人口):"+g+" growth rate:"+g2+" HI:"+g5+" VI:"+g6);
		}
		...
		for(int i=page+1;i<page+11;i++)
		{
			...
			if(a13.a1.populationdy[i]>0)
				g6=(double)a13.a1.populationviolence[i]*100/(double)a13.a1.populationdy[i];
				else g6=0;
			...
			a13.setbl((i-page)+30, 720,130+(i-page)*30, 490, 30, 1,(i*10-9)+"-"+(i*10)+"年   pop:"+a13.a1.population[i]+"  growth(%):"+a13.a1.populationgrow[i]+"   HI:"+g5+"  VI:"+g6+"  tribes number:"+a13.a1.populationtribe[i]);
		}
		a13.setbl(7, 720,470, 450, 30, 1, "Every decade. pop=population  HI=hunger, VI=violence");
		a13.setbl(8, 720,500, 450, 30, 1, "HI(%)=(starve/total death)  VI(%)=(be killed/total death)");
		a13.setbl(9, 720,530, 400, 30, 1, "lefe,right: change pages  E: return  V: change");
	...
	void bfs_gr(int k,int l)
	{
		System.out.println("bfs "+k+" l=" +l+"\n");
		gh0[k]=l;
		rk[rank]=k;
		rank++;
		for(int z=0;z<a13.a1.group[k].sonn;z++)
		{
			bfs_gr(a13.a1.group[k].son[z],l+1);		
		}
	}
	

	
	void showgrouphistory(int h) {//q==22
		...
		a13.setbl(3, 720,130, 350, 30, 1, "部落歷史源由:");
		...
		for(int z=h;z<h+10;z++)
		{
			if(z>=rank)
				break;
			String y="";
			for(int i=0;i<gh0[rk[z]];i++)
				y+="    ";
			for(int i=0;i<gh0[rk[z]];i++)
				y+="*";
			
			g=rk[z];
			if(a13.a1.group[z].leader>=0)
			a13.setbl((z-h)+31, 720,170+(z-h)*30, 420, 30, 1, y+a13.a1.group[g].name+" tribe  nember:"+a13.a1.group[g].gnumber+"  ("+a13.a1.group[g].createtime+"~"+" )");
			else
				a13.setbl((z-h)+31, 720,170+(z-h)*30, 420, 30, 1, y+a13.a1.group[g].name+" tribe (dead)  ("+a13.a1.group[g].createtime+"~"+a13.a1.group[z].dietime+")");	
		
			a13.setaf(1100,170+(z-h)*30,50,25,g);
		}
	...
	//	a13.setbl(1, 720,70, 350, 30, 1, "在世人數:"+a13.a1.people+"人");
	//	a13.setbl(2, 720,100, 350, 30, 1, "歷史累積人數:"+a13.a1.allbn+"人");
		a13.setbl(3, 720,130, 550, 30, 1, "歷史累積部落數(number of tribes):"+a13.a1.groupn);
		a13.setbl(4, 720,160, 550, 30, 1, "部落一覽(All tribes):");
		...
		//	System.out.println("ma:"+"》"+a13.a1.allb[i].ma());
			...
			a13.setbl((i-page)+31, 720,200+(i-page)*30, 460, 30, 1, a13.a1.group[i].name+" tribe  "+" population:"+a13.a1.group[i].gnumber+"  x:"+a13.a1.group[i].placex+" y:"+a13.a1.group[i].placey);
			else
				a13.setbl((i-page)+31, 720,200+(i-page)*30, 460, 30, 1, a13.a1.group[i].name+" tribe (dead)");
			
			a13.setaf(1100,200+(i-page)*30,50,25,i);
